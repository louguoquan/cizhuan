...
+ (id)get:(NSString *)path completionHandler:(void (^)(id, NSError *))completionHandler{
    ...
    NSURLSessionDataTask *task = [[NSURLSession sharedSession] dataTaskWithURL:path.rm_URL completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
