    ...
    switch (indexPath.section)
    {
        case 0:
        {
            ...
            for (NSInteger i = 0; i < self.allHotbrands.count; i++)
            {
                ...
                [cell.iconIVs[i] yy_setImageWithURL:model.img.rm_URL options:YYWebImageOptionShowNetworkActivity];
        ...
        case 1:
        {
            ...
            for (NSInteger i = 0; i < self.allAdvert.count; i++)
            {
                ...
                [cell.iconIV[i] yy_setImageWithURL:model.img.rm_URL options:YYWebImageOptionShowNetworkActivity];                cell.nameLB[i].text = model.seriesname;
            }
            return cell;
        }
        default:
