...
#define YSCITY_PATH   [PATH_OF_DOCUMENT stringByAppendingPathComponent:@"city.archiver"]
#define YSCITYSECTIONS_PATH   [PATH_OF_DOCUMENT stringByAppendingPathComponent:@"citySections.archiver"]

@interface YSCityViewController ()
...
@implementation YSCityViewController
...
{
    WS(weakSelf);
    [MBProgressHUD showLoadingText:@"正在获取城市列表" toContainer:self];
    
    [[SDDispatchingCenter sharedCenter] GET:kAllCitys_URL parameters:@{@"provinceId":_provinceId} success:^(NSURLSessionDataTask *task, id responseObject) {
...
//    }
    [[NSNotificationCenter defaultCenter]postNotificationName:@"选择城市" object:city.name];
