...
- (void)setupUI{
    ...
    [self.tableView registerClass:[JJMessageTableViewCell class] forCellReuseIdentifier:@"JJHistoryTableViewCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    JJMessageTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JJHistoryTableViewCell"];
