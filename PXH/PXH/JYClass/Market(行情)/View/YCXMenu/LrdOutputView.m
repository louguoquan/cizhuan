...
- (instancetype)initWithDataArray:(NSMutableArray *)dataArray
    ...
    if (self = [super initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)]) {
        ...
        //注册cell
        [_tableView registerClass:[JYOutPutCell class] forCellReuseIdentifier:@"JYOutPutCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    JYOutPutCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JYOutPutCell"];
    //取出模型
...
- (instancetype)initWithTitle:(NSString *)title imageName:(NSString *)imageName index:(NSString *)index{
