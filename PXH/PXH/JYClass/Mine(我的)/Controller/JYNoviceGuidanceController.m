...
@interface JYNoviceGuidanceController ()
{
    NSInteger       page;
}
...
@implementation JYNoviceGuidanceController
...
- (void)setupTableView
{
//    _listArr = @[@"新手操作", @"人民币充值", @"提现人民币", @"常见问题"];
...
{
    WS(weakSelf)
    [JYMineService cmsIndexListWithId:@"1" page:page completion:^(id result, id error) {
