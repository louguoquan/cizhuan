...
@property (nonatomic, readonly) BOOL isRecordEnabled;

@property (nonatomic, readonly) BOOL isPhotoEnabled;

@property (nonatomic, readonly) BOOL isContactEnabled;
