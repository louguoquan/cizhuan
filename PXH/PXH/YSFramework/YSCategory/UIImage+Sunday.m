...
#import "UIImage+Sunday.h"
#import "UIDevice+Sunday.h"
#import "NSString+Sunday.h"
#import "YYKitMacro.h"
...
//    CIImage *output = [image.CIImage imageByApplyingTransform:transform];
...
- (UIImage *)imageByPerfectBlur {
    UIColor *tintColor = [UIColor colorWithWhite:0.1 alpha:0.05];
    return [self imageByBlurRadius:20 tintColor:tintColor tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}
