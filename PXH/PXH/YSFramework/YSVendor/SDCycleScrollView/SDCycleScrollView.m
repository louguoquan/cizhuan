...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.delegate respondsToSelector:@selector(collectionViewCell:cellForItemAtIndexPath:)]) {
        cell = [self.delegate collectionViewCell:cell cellForItemAtIndexPath:itemIndex];
    }
